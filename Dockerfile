# Same as deploy/Dockerfile — RelaxDev reads ./Dockerfile from repo root.
...
RUN pnpm --filter @workspace/litematic-hub run build
...
ENV PARSE_HEAP_MB=1024
ENV HOSTING_MAX_UPLOAD_MB=0
